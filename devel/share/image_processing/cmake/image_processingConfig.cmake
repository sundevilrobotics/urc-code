...
if("TRUE" STREQUAL "TRUE")
  set(image_processing_SOURCE_PREFIX /home/brandon/catkin_ws/src/urc-code/src/image_processing)
  set(image_processing_DEVEL_PREFIX /home/brandon/catkin_ws/src/urc-code/devel)
  ...
  set(image_processing_INSTALL_PREFIX /home/brandon/catkin_ws/src/urc-code/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Brandon Rice <bjrice13@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_processing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/brandon/catkin_ws/src/urc-code/src/image_processing/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/brandon/catkin_ws/src/urc-code/devel/lib;/home/brandon/catkin_ws/devel/lib;/opt/ros/melodic/lib)
...
set(depends "roscpp;std_msgs;cv_bridge;image_transport")
